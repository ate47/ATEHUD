...
public class GuiColorSelector extends GuiScreen {
	...
	public GuiColorSelector(GuiExplosionSelector editor, GuiScreen lastGui, boolean fadeColor, int index) {
		if (!fadeColor) {
			...
			if (editor.getFadeColorSize() > index && index >= 0)
				Index = index;
		}
		color = Colors.WHITE;
		FadeColor = fadeColor;
	...
	public void initGui() {
		fontRendererObj.drawSplitString(I18n.format("item.fireworksCharge.red"), width / 2 - 150,
				height / 2 - 64 - fontRendererObj.FONT_HEIGHT, 100, Colors.WHITE);
		fontRendererObj.drawSplitString(I18n.format("item.fireworksCharge.green"), width / 2 - 50,
				height / 2 - 64 - fontRendererObj.FONT_HEIGHT, 100, Colors.WHITE);
		fontRendererObj.drawSplitString(I18n.format("item.fireworksCharge.blue"), width / 2 + 50,
				height / 2 - 64 - fontRendererObj.FONT_HEIGHT, 100, Colors.WHITE);

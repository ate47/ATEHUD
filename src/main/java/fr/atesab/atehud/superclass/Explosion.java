...
public class Explosion {
	...
	public Explosion() {
		...
		Trail = 0;
		Type = 0;
		Colors = new int[] { fr.atesab.atehud.superclass.Colors.DYE_WHITE };
		FadeColors = new int[] {};
	}
	 ...
	 * 
	 * @param flicker
	 *            1 or 0 (true/false) - true if this explosion will have the Twinkle
	 *            effect (glowstone dust)
	 * @param trail
	 *            1 or 0 (true/false) - true if this explosion will have the Trail
	 *            effect (diamond)
	 * @param type
	 *            The shape of this firework's explosion. 0 = Small Ball, 1 = Large
	 *            Ball, 2 = Star-shaped, 3 = Creeper-shaped, 4 = Burst. Other values
	 *            will be named "Unknown Shape" and render as Small Ball.
	 * @param colors
	 *            Array of integer values corresponding to the primary colors of
	 *            this firework's explosion.
	 * @param fadecolors
	 *            Array of integer values corresponding to the fading colors of this
	 *            firework's explosion.
	 */
	...
	public String toString() {
		return "Explosion [Flicker=" + Flicker + ", Trail=" + Trail + ", Type=" + Type + ", Colors="
				+ Arrays.toString(Colors) + ", FadeColors=" + Arrays.toString(FadeColors) + "]";
	}

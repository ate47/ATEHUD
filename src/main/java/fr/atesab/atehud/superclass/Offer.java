...
public class Offer {
	 ...
	 * 
	 * @param rewardExp
	 *            1 or 0 (true/false) - true if this trade will provide XP orb
	 *            drops.
	 * @param maxUses
	 *            The maximum number of times this trade can be used before it is
	 *            disabled. Increases by a random amount from 2 to 12 when offers
	 *            are refreshed.
	 * @param uses
	 *            The number of times this trade has been used. The trade becomes
	 *            disabled when this is greater or equal to maxUses.
	 * @param buy
	 *            The first 'cost' item, without the Slot tag.
	 * @param sell
	 *            The item being sold for each set of cost items, without the Slot
	 *            tag.
	 */
	...
	public void setBuy(ItemStack value) {
		Buy = value;
	}

	public void setBuyB(ItemStack value) {
		BuyB = value;
	}
	...
	public void setSell(ItemStack value) {
		Sell = value;
	}

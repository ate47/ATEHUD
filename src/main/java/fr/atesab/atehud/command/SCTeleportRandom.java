...
public class SCTeleportRandom extends SubCommand {
	private final ArrayList<String> aliases;

	public SCTeleportRandom() {
		super("tpr", I18n.format(I18n.format("teleporter.teleport.random").replaceAll("::", " ")),
				CommandClickOption.doCommand);
		aliases = new ArrayList<String>();
		aliases.add(getName());
		aliases.add("tprandom");
	}
	...
	public void processSubCommand(ICommandSender sender, String[] args, MainCommand mainCommand)
		...
		GameProfile gf = list.get((int) (list.size() * (new Random().nextFloat()))).getGameProfile();
		GuiTeleporter.teleport(gf);
	}
}
